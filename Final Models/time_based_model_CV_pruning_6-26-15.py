...
# adding some more times
MT_MIN_30 = 17.25 * 3600.0
TT_MIN_30 = 8.0 * 3600.0
TT_PLUS_30 = 9.0 * 3600.0
THT_PLUS_30 = 18.5 * 3600.0
FT_MIN_30 = 3.5 * 3600.0
FT_PLUS_30 = 4.5 * 3600.0
ST_MIN_30 = 14.0 * 3600.0
ST_PLUS_30 = 15.0 * 3600.0
...
def trimLine(poly_line, start_time, end_time):
    ...
    elif(MT_MIN_30 > start_time and MT_MIN_30 < end_time):
        cut_time = MT_MIN_30
    elif(TT_MIN_30 > start_time and TT_MIN_30 < end_time):
        cut_time = TT_MIN_30
    elif(TT_PLUS_30 > start_time and TT_PLUS_30 < end_time):
        cut_time = TT_PLUS_30
    elif(THT_PLUS_30 > start_time and THT_PLUS_30 < end_time):
        cut_time = THT_PLUS_30
    elif(FT_MIN_30 > start_time and FT_MIN_30 < end_time):
        cut_time = FT_MIN_30
    elif(FT_PLUS_30 > start_time and FT_PLUS_30 < end_time):
        cut_time = FT_PLUS_30
    elif(ST_MIN_30 > start_time and ST_MIN_30 < end_time):
        cut_time = ST_MIN_30
    elif(ST_PLUS_30 > start_time and ST_PLUS_30 < end_time):
        cut_time = ST_PLUS_30
    else:
        return(([],0,-999,-999))
    new_time = start_time
...
train = train[['CALL_TYPE_A', 'CALL_TYPE_B', 'CALL_TYPE_C', 'LAT1', 'LAT3', 'LONG1', 'LONG3',\
       ...
       'TIME_WEEKDAY', 'TIME_YEAR', 'COS', 'SIN', 'START_COS', 'START_SIN', 'LATF', 'LONGF']]
test = test[['CALL_TYPE_A', 'CALL_TYPE_B', 'CALL_TYPE_C', 'LAT1', 'LAT3', 'LONG1', 'LONG3',\
       'ORIGIN_CALL', 'ORIGIN_STAND', 'TAXI_ID', 'TIME_MONTH',\
       'TIME_WEEKDAY', 'TIME_YEAR', 'COS', 'SIN', 'START_COS', 'START_SIN']]
...
for msl in min_samples_leaf:
   ...
   clf = ensemble.RandomForestRegressor(n_estimators=300, n_jobs=1, min_samples_leaf=msl, verbose=1)
...
# clf = ensemble.RandomForestRegressor(n_estimators=800, n_jobs=1, min_samples_leaf=5, verbose=1)
# clf.fit(train, label)
...
# sample.to_csv('./data/result_06-26-15_more_times_min_samples_leaf_5.csv', index = False)
